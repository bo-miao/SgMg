...
if __name__ == '__main__':
    ...
    for (dataset, dataset_split) in zip(datasets, datasets_split):
        convert_to_coco(data_root='/home2/useradmin/Documents/dataset/coco', output_root='/home2/useradmin/Documents/dataset/coco2', dataset=dataset, dataset_split=dataset_split)
        print("Done.")
