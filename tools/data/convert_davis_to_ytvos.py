...
def read_split_set(data_root='data/refer_davis'):
...
def mv_images_to_folder(data_root='data/refer_davis', output_root='data/refer_davis'):
...
def create_meta_expressions(data_root='data/refer_davis', output_root='data/refer_davis'):
    """
...
def create_meta_annotaions(data_root='data/refer_davis', output_root='data/refer_davis'):
    """
